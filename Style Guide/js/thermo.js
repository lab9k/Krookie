...
function thermometer() {
	...
	document.getElementById('redButton').addEventListener('click',function(){
  		document.getElementById('redanimation').beginElement();
	},false);
	document.getElementById('blueButton').addEventListener('click',function(){
  		document.getElementById('blueanimation').beginElement();
	},false);
	document.getElementById('orangeButton').addEventListener('click',function(){
  		document.getElementById('orangeanimation').beginElement();
	},false);
